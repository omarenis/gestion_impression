                    ...
                    <div class="col-md-12">
                        <div class="card ">
                            <div class="card-header ">
                                ...
                                <a class="btn btn-success" type="button" href="<%= request.getContextPath()%>/adduser">add user</a>
                                <% } %>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                                ...
                                                <c:forEach var="row" items="${users}">
                                                    <tr>
                                                        ...
                                                        <c:if test="${row.role != 'admin'}">
                                                            <form class="text-right" method="post" action="users.jsp">
                                                                <button type="submit" name="changeStatus" class="btn ${row.isActivated ? 'btn-danger' : 'btn-success'}">
                                                                    ${row.isActivated ? 'deactivate': 'activate'} account
                                                                </button>
