                                    ...
                                    <div class="col-12">
                                        <div class="table-responsive">
                                            <table class="table">
                                                ...
                                                <th class="text-center">firstname and lastname of teacher</th>
                                                <th class="text-center">number of copies</th>
                                                <th class="text-center">date of reception</th>
                                                <th class="text-center">Document</th>
                                                </thead>
                                                <tbody>
                                                <c:forEach var="row" items="${printActions}">
                                                    <tr>
