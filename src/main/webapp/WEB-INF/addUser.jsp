        ...
        <div class="content">
            <div class="container">
                <div class="col-md-6 col-sm-12 ml-auto mr-auto">
                    <form class="form" method="post" action="/management_teachers_impression_war_exploded/users">
                        <div class="card card-login card-hidden">
                            <div class="card-header ">
                                <h3 class="header text-center">add user</h3>
                            </div>
                            <div class="card-body">
                                <div class="card-body">
                            ...
                            <div class="card-footer ml-auto mr-auto">
                                <button type="submit" class="btn btn-warning btn-wd">add user</button>
                            </div>
                        </div>
                    </form>
                </div>
